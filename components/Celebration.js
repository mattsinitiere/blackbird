  ...
  return (
    <div className="celeb-overlay">
      ...
      <div className="celeb-text">
        <div className="celeb-big">{type === "win" ? "WINNER!" : type === "180" ? "180!" : type === "shanghai" ? "SHANGHAI!" : type === "halved" ? "HALVED!" : type === "reset" ? "RESET!" : type === "badge" ? "BADGE UNLOCKED" : label || "Nice!"}</div>
