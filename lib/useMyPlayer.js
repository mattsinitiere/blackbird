...
const COLS = ["username, created_at, hidden, elo, color, auth_id, handle, bio, location", "username, created_at, hidden, elo, color, auth_id", "username, created_at, hidden, elo, color"];
