...
export const FAQS = [
  ...
  },
  {
    ...
    a: "It answers from Blackbird game data: your games and stats, and the shared results of players you ask about. To write an answer, your question and the data it needs are sent to an AI model provider.",
  },
  {
    q: "Who is Merlin?",
