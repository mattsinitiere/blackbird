...
/**
 * What the colour pickers offer: Blackbird navy first, then the palette.
 * Kept separate from PLAYER_COLORS, which also assigns default colours by
 * hashing the name; growing that list would change people's defaults.
 */
export const PICKER_COLORS = ["#26214d", ...PLAYER_COLORS];
